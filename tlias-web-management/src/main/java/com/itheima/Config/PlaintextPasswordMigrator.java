 ...
 * 通过 tlias.security.migrate-plaintext-password 开关控制，迁移后请关闭。
 */
@Slf4j
@Component
public class PlaintextPasswordMigrator implements ApplicationRunner {

    @Value("${tlias.security.migrate-plaintext-password:false}")
    ...
    public void run(ApplicationArguments args) {
        ...
        log.warn("明文密码迁移完成，共 {} 条。请将 tlias.security.migrate-plaintext-password 改为 false", migrated);
    }
