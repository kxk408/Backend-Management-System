...
import com.backend.mapper.EmpMapper;
 ...
 * 通过 backend.security.migrate-plaintext-password 开关控制，迁移后请关闭。
 */
@Slf4j
@Component
public class PlaintextPasswordMigrator implements ApplicationRunner {

    @Value("${backend.security.migrate-plaintext-password:false}")
    ...
    public void run(ApplicationArguments args) {
        ...
        log.warn("明文密码迁移完成，共 {} 条。请将 backend.security.migrate-plaintext-password 改为 false", migrated);
    }
